...
* Last Modification Date:		04-20-2015
* Lab Number:					Lab 2, Sorts
* File Name:					Lab_2_Sorts.cpp
*
*	  Overview: This program is a collection of sorting algorithms.  
*				The algorithms included are: BubbleSort, SelectionSort,
*				InsertionSort, ShellSort, QuickSort, HeapSort, 
*				MergeSort, and ShakerSort.
*	
*		 Input: No user input is required.
*	
*		Output:	A report of the duration of time the sort took to sort
*				the data passed in, in the format:
*					
*					"Name of sort" took HRS:MI:SE.MSE
*
*				Three times appear for each sort, the first is for the 
*				native C++ array, the second is for the Array class 
*				written by the students, the third is for the STL Vector
*				class.  This information is also written to the text
*				file, "SortTimes.txt".  The format of the file is
*				similar to the console window report.
*		
**********************************************************************/
...
template< typename T >
void ShakerSort( T & unsorted, int n );
//TreeSort
//BinaryInsertionSort
//RadixSort
...
int main( int argc, char* argv[  ] )
{
	...
	if( argc > 1 )
	{
		...
		cout << "The number of elements in each array is " << n << ".\n";

		cout << "Starting Bubble Sorts\n";
		...
		cout << "Starting Flagged Bubble Sorts\n";
		...
		cout << "Starting Shaker Sorts\n";
		ShakerSort( unsorted_native, n );
		ShakerSort( unsorted_written, n );
		ShakerSort( unsorted_vector, n );

		delete [  ] unsorted_native;
		delete [  ] unsorted_native_seed;

		unsorted_native = nullptr;
		unsorted_native_seed = nullptr;
	}
	else
	{
...
*	void ShakerSort( T & unsorted, int n )
*
*	   Purpose: This sort is similar to the BubbleSort.  The key 
*				difference is after one pass of bubbling a large value
*				to the end of the array, a return pass is made that 
*				sinks the smallest value to the end of the array.
*
*		 Entry:	'unsorted' is an array of values in random order.
*
*		  Exit: The values in 'unsorted' are now in correct ascending
...
void ShakerSort( T & unsorted, int n )
{
	...
	TimingAndOutput( "ShakerSort", start, end );
}
