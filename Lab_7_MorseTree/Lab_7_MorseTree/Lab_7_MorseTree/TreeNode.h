...
class TreeNode
{
	...
	// Mutator methods
		...
		// Parent pointer mutator
		void SetParent( TreeNode< T > * Parent );

	private:
		T mData;							// Data stored in the TreeNode
		TreeNode< T > * mLeftChild;			// Pointer to the LeftChild TreeNode
		TreeNode< T > * mRightChild;		// Pointer to the RightChild TreeNode
		TreeNode< T > * mParent;			// Pointer to the Parent TreeNode
};
...
//
	...
	**********************************************************************/
	template< typename T >
	TreeNode< T >::TreeNode(  ) : 
						mData(  ), mLeftChild( nullptr ), mRightChild( nullptr ), mParent( nullptr )
	{  }
	...
	**********************************************************************/
	...
	TreeNode< T >::TreeNode( T Data ) : 
						mData( Data ), mLeftChild( nullptr ), mRightChild( nullptr ), mParent( nullptr )
	{  }
	...
	**********************************************************************/
	...
	TreeNode< T >::TreeNode( const TreeNode< T > & copy ) :
						mData( copy.mData ), mLeftChild( copy.mLeftChild ), mRightChild( copy.mRightChild ), mParent( copy.mParent )
	{  }
...
//
	...
	*
	*		 Entry:	'mLeftChild' is the pointer to the LeftChild TreeNode in the tree.
	*
	...
	*
	*		 Entry:	'mRightChild' is the pointer to the RightChild TreeNode in the tree.
	*
	...
	*
	*	   Purpose: Accesses the parent TreeNode.
	*
	*		 Entry:	'mParent' is the pointer to the parent TreeNode in the tree.
	*
	*		  Exit:	'mParent' is returned.
	*
	**********************************************************************/
	template< typename T >
...
//
	...
	*
	*	   Purpose: Changes the TreeNode the RightChild pointer is pointing at.
	*
	...
	*
	*	   Purpose: Changes the TreeNode the parent pointer is pointing at.
	*
	*		 Entry:	'Parent' is a TreeNode pointer.
	*
	*		  Exit: 'mParent' is now 'Parent'.
	*
	**********************************************************************/
	template< typename T >
	void TreeNode< T >::SetParent( TreeNode< T > * Parent )
