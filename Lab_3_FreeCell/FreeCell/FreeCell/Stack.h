...
class Stack
{
	...
	// Member functions
		...
		// Changes the size of the stack to a new size
...
//
	...
	*
	*	   Purpose:	Resizes the stack to the passed in value.
	*
	*		 Entry: 'size' is the value the Stack is to be set to.	
	*
	*		  Exit: The stack is set to a new size, regardless of data
	*				stored in the Stack.
	*
	**********************************************************************/
	template< typename T >
