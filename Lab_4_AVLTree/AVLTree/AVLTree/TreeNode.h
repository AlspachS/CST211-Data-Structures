...
* Filename: TreeNode.h
*
*		A node to store Data for a binary tree.
*
* Constructors:
*			TreeNode(  )
...
*				Sets the balance factor of a TreeNode.
*
*	   Methods:
*			T GetData(  ) const
...
*				Returns the balance factor of a TreeNode.
*
***********************************************************************/
#ifndef	TreeNode_H
#define TreeNode_H
...
class TreeNode
{
	...
	// Mutator methods
		...
		// RightChild pointer mutator
		void SetRightChild( TreeNode< T > * RightChild );

		// Balance factor mutator
	...
	private:
		...
		int mBalance;						// Used with AVL trees
};
...
//
	...
	**********************************************************************/
	template< typename T >
	TreeNode< T >::TreeNode(  ) : 
						mData(  ), mLeftChild( nullptr ), mRightChild( nullptr ), mBalance( 0 )
	{  }
	...
	**********************************************************************/
	...
	TreeNode< T >::TreeNode( T Data ) : 
						mData( Data ), mLeftChild( nullptr ), mRightChild( nullptr ), mBalance( 0 )
	{  }
	...
	**********************************************************************/
	...
	TreeNode< T >::TreeNode( const TreeNode< T > & copy ) :
						mData( copy.mData ), mLeftChild( copy.mLeftChild ), 
						mRightChild( copy.mRightChild ), mBalance( copy.mBalance )
	{  }
...
//
	...
	**********************************************************************/
	...
	/**********************************************************************
	*	TreeNode< T > TreeNode< T >::GetBalance(  )
	*
	*	   Purpose: Accesses the balance factor of a TreeNode.
	*
	*		 Entry:	'mBalance' is the balance facter of the TreeNode.
	*
	*		  Exit:	'mBalance' is returned.
	*
	**********************************************************************/
	template< typename T >
	int TreeNode< T >::GetBalance(  ) const
	{
		return mBalance;
	}
...
//
	...
	**********************************************************************/
	...
	/**********************************************************************
	*	void TreeNode< T >::SetBalance( int balance )
	*
	*	   Purpose: Changes the balance of a TreeNode.
	*
	*		 Entry:	'balance' is the new TreeNode balance factor.
	*
	*		  Exit: 'mBalance' is now 'balance'.
	*
	**********************************************************************/
	template< typename T >
	void TreeNode< T >::SetBalance( int balance )
